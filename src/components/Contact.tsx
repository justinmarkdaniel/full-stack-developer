...
const Contact = ({ onOpenContact }: ContactProps) => {
  return (
    <section id="contact" className="py-32 px-4 md:px-6 overflow-hidden">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <a
                    ...
                    className="font-mono hover:text-primary transition-colors text-sm md:text-base break-all"
                  >
            ...
            <div className="p-6 rounded-xl border border-border bg-card/50 backdrop-blur-sm hover:border-primary/30 transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="font-mono text-sm md:text-base">Central Coast, NSW, Australia</p>
                </div>
              </div>
            </div>
